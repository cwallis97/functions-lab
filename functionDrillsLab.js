...
//CODE HERE
const jsNinja = () => "I am a JacaScript ninja!";
console.log(jsNinja());
...
const result = compareNums(5, 8);
console.log(result);
const equalResult = compareNums(10, 10);
...
const nameGreeting = nameCheck("chris");
...
let arrayElvaluator = bigOrSmall(bigOrSmallArray);
console.log(arrayElvaluator);
...
const result1 = emailCheck("user@example.com");
console.log(result1);
